...
class PlayerMatchEloCalculator(PlayerCalculatorMixin, TeamEloCalculator):
    """Stateful match-by-match player Elo calculator."""
    ...
    def process_match(self, match_result: PlayerMatchResult) -> list[PlayerMatchEloEvent]:
        ...
        events: list[PlayerMatchEloEvent] = []

        for participant in match_result.team1_players:
            ...
            self._last_event_times[participant.player_id] = match_result.event_time
        ...
        for participant in match_result.team2_players:
